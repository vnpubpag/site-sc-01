(async ()=>{
    ...
    function Q(t, o, e) {
        ...
        if (o) {
            ...
            return u.length > 0 && c.push(u), c.map((i)=>L(i, e));
        }
        const s = [];
        let n = [
            t[0]
        ...
        return n.length > 0 && s.push(L(n, e)), s;
    }
    function k(t) {
        const o = [];
        let e = null;
    ...
    async function bt(t) {
        const o = await yt(t);
        if (!o) return [];
        const { createWorker: e } = await import("./index-DIi5oGTW.js").then(function(n) {
            return n.i;
