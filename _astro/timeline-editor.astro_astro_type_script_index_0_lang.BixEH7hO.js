            ...
            <div class="tl-item__content">
                <div class="tl-card__actions">
                    <label class="tl-card__action-btn tl-card__action-btn--color" title="Đổi màu">
                        <input type="color" class="tl-color-input" data-id="${t.id}" value="${n}" />
                        <svg width="14" height="14" viewBox="0 0 14 14"><circle cx="7" cy="7" r="5.5" fill="${n}" stroke="#d1d5db" stroke-width="1"></circle></svg>
                    </label>
                    <button class="tl-card__action-btn" data-action="edit" data-id="${t.id}" title="Sửa">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                            <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                        </svg>
                    </button>
                    <button class="tl-card__action-btn tl-card__action-btn--delete" data-action="delete" data-id="${t.id}" title="Xóa">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <div class="tl-card">
                    <span class="tl-card__time">${d}</span>
